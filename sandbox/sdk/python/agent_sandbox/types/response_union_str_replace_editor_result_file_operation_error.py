...
class ResponseUnionStrReplaceEditorResultFileOperationError(UniversalBaseModel):
    ...
    data: typing.Optional[ResponseUnionStrReplaceEditorResultFileOperationErrorData] = pydantic.Field(default=None)
    """

...
class ResponseUnionFileWriteResultFileOperationError(UniversalBaseModel):
    ...
    data: typing.Optional[ResponseUnionFileWriteResultFileOperationErrorData] = pydantic.Field(default=None)
    """

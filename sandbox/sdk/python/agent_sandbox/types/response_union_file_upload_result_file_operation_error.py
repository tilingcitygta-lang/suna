...
class ResponseUnionFileUploadResultFileOperationError(UniversalBaseModel):
    ...
    data: typing.Optional[ResponseUnionFileUploadResultFileOperationErrorData] = pydantic.Field(default=None)
    """

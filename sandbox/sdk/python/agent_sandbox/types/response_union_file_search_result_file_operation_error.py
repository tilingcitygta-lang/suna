...
class ResponseUnionFileSearchResultFileOperationError(UniversalBaseModel):
    ...
    data: typing.Optional[ResponseUnionFileSearchResultFileOperationErrorData] = pydantic.Field(default=None)
    """

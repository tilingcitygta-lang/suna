...
class ResponseUnionFileReplaceResultFileOperationError(UniversalBaseModel):
    ...
    data: typing.Optional[ResponseUnionFileReplaceResultFileOperationErrorData] = pydantic.Field(default=None)
    """

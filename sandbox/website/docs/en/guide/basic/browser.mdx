...
## Related Browser Topics

- [Display Recording](/guide/basic/display) for full desktop MP4 capture
- [Browser Configuration](/guide/advanced/browser-config) for language, homepage, user agent, and launch flags
- [Browser Cookies And State](/guide/advanced/browser-cookies) for cookie injection and state save/load
- [Browser Downloads](/guide/advanced/browser-downloads) for download directories and retrieval

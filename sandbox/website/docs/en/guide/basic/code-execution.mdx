...
This page is kept as an overview. For the current split guides, see [Unified Code Execution](/guide/basic/code), [Jupyter](/guide/basic/jupyter), and [Node.js](/guide/basic/nodejs).
...
- **Multiple Kernels**: Support for Python 3.10, 3.11, and 3.12 kernels
...
# Output: ['python3', 'python3.10', 'python3.11', 'python3.12']

# Use Python 3.10
result_py310 = client.jupyter.execute_code(
    code="""
import sys

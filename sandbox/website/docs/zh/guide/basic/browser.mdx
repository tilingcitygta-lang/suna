...
- [屏幕录制](/zh/guide/basic/display)：录制完整桌面 MP4
- [浏览器配置](/zh/guide/advanced/browser-config)：配置语言、首页、User-Agent 和启动参数
- [浏览器 Cookie 与状态](/zh/guide/advanced/browser-cookies)：Cookie 注入与状态保存/加载
- [浏览器下载](/zh/guide/advanced/browser-downloads)：下载目录与文件取回
